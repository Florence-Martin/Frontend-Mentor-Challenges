      ...
      <section className="bg-[var(--background)] text-[var(--foreground)] max-w-2xl mx-auto ">
        <div className="bg-[var(--background)] text-[var(--foreground)] max-w-2xl mx-auto px-10 py-8 transition-colors">
          ...
          <p className="text-preset-7 font-sans  text-left m">
            ...
            personal adventures? Sign up for my newsletter! It&apos;s a simple
            way to keep track of new posts and occasional coding tips I
            discover. Just drop your email in the sign-up box, and I&apos;ll
            send you updates whenever there&apos;s something new to share.
          </p>
          <br />
